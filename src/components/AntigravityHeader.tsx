          ...
          {isMobileMenuOpen && (
            ...
            >
              <nav className="py-4 space-y-2" role="navigation" aria-label="Navigation mobile">
                ...
                {/* Role-specific mobile links for authenticated users */}
                {user && (
                  <div className="px-4 pt-4 border-t border-border/50 space-y-1">
                    <div className="px-4 py-2 text-xs font-semibold text-muted-foreground uppercase tracking-wider">
                      Mon Compte
                    </div>
                    ...
                    {isProvider && (
                      <Link
                        ...
                        className="flex items-center gap-2 px-4 py-2 text-sm text-primary font-medium hover:bg-muted/50"
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
                        <Stethoscope className="h-4 w-4" />
                        Espace Praticien
                    ...
                    {isAdmin && (
                      <Link
                        to="/admin/dashboard"
                        className="flex items-center gap-2 px-4 py-2 text-sm text-destructive font-medium hover:bg-muted/50"
                        onClick={() => setIsMobileMenuOpen(false)}
                      >
                        <Shield className="h-4 w-4" />
                        Administration
